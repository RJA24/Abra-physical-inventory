...
ABRA_COORDS = {
    'BANGUED': [17.5999792, 120.6157925], 'BOLINEY': [17.3917, 120.8167], 'BUCAY': [17.5333, 120.7333],
    'BUCLOC': [17.4500, 120.8333], 'DAGUIOMAN': [17.4500, 120.9333], 'DANGLAS': [17.6934864, 120.6622733],
    'DOLORES': [17.648230, 120.708557], 'LA PAZ': [17.642660, 120.628028], 'LACUB': [17.6615852, 120.9506456],
    ...
    'SAN ISIDRO': [17.4667, 120.6000], 'SAN JUAN': [17.684537, 120.733255], 'SAN QUINTIN': [17.5333, 120.5167],
    'TAYUM': [17.617766, 120.6523313], 'TINEG': [17.7833, 120.9333], 'TUBO': [17.2333, 120.8000], 
    'VILLAVICIOSA': [17.4333, 120.6333],
    'PHO': [17.6068448, 120.6180127], 'APH': [17.6160275, 120.6164212]
}
